...
4. Wait for every file to finish uploading — there are 40 of them, including 18 pages.
...
The project folder is already a Git repository with two commits in it, so you only need to connect it to GitHub and push.
